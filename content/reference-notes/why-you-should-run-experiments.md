...
- [[literature-notes/experiments-make-knowledge-embodied|Experiments create embodied knowledge, not book learning]]
- [[literature-notes/experiments-separate-identity-from-behavior|Experiments separate identity from behavior]]
- [[literature-notes/dont-make-experiments-a-should|Don't make experiments a should—keep them playful]]
- [[literature-notes/managing-yourself-kills-the-practice|Using a practice to manage yourself makes it stop working]]
- [[literature-notes/follow-your-migratory-path|Follow your natural migratory path through experiments]]
- [[literature-notes/test-what-you-know-least-first|Test the thing you know least about first]]
- [[literature-notes/stay-in-discomfort-iterate-on-shoulds|Stay when experiments get uncomfortable, iterate when they become shoulds]]
- [[literature-notes/we-are-always-running-experiments|We are always running experiments—the question is whether consciously]]
